...
- **2026-06-02** — feat(go-b3): port timeline, file-structure, tree, rebase + internal config/decisions/timeline/tree packages with byte-identical Python v0.6.14 output
<!-- logmind-entry-end -->
