...
- **2026-07-17** — fix(doctor): version regex also accepts the legacy Click shape — stale Python binary stays classified (#214 review) *(fix/batch-b-hooks-doctor-hang-guard)* — [decisions-branches/fix__batch-b-hooks-doctor-hang-guard.md](decisions-branches/fix__batch-b-hooks-doctor-hang-guard.md)
- *... 52 more decisions ...*
