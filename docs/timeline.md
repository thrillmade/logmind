...
- **2026-06-29** — Self-heal the derived-doc CI gate so it never blocks PRs (friction #1, Slice 1) *(fix/derived-doc-gate-self-heal)* — [decisions-branches/fix__derived-doc-gate-self-heal.md](decisions-branches/fix__derived-doc-gate-self-heal.md)
- *... 89 more decisions ...*
