...
- **2026-07-17** — fix(cli): single shared stdin reader, one nudge deadline, stdin-readable self-heal gate *(fix/cli-3.1.1-stderr-nudge-pulse)* — [decisions-branches/fix__cli-3.1.1-stderr-nudge-pulse.md](decisions-branches/fix__cli-3.1.1-stderr-nudge-pulse.md)
- *... 52 more decisions ...*
