...
- **2026-06-29** — Shape-up plan: sequence logmind de-friction blocker-first; ship the self-heal CI gate first *(docs/shape-up-de-friction-plan)* — [decisions-branches/docs__shape-up-de-friction-plan.md](decisions-branches/docs__shape-up-de-friction-plan.md)
- *... 89 more decisions ...*
