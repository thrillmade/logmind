...
- **2026-06-02** — fix(v0.6.15): logmind log regens derived docs before committing *(feat/v0.6.15-default-branch-hook-skip)* — [decisions-branches/feat__v0.6.15-default-branch-hook-skip.md](decisions-branches/feat__v0.6.15-default-branch-hook-skip.md)
- *... 22 more decisions ...*
